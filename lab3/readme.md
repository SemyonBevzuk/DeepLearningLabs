...
Лучший результат показала сеть **CNN_7_elu - 0.9441**.
Сети с активацией через sigmoid лучше других решают задачу классификации.

Применение dropout не сильно улучшило результат.

Лучший результат для ReLU: **CNN_7_relu - 0.9315**.

Лучший результат для Sigmoid: **CNN_3_sigmoid - 0.8924**.
