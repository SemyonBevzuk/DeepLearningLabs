...
def run_experiment_NASNetMobile_with_fully_connected_layers_zoom_data():
    ...
    params = {'batch_size': 128,
              'num_epochs': 10,
              'label': 'NASNetMobile_512_256_128_64_zoom_data',
              'img_size': 256}
...
def main():
    ...
    print('\n\tBase NASNetMobile zoom data 256\n')
    run_experiment_base_NASNetMobile_zoom_data()

    print('\n\tBase NASNetMobile_512_256_128_64 zoom data 256\n')
    run_experiment_NASNetMobile_with_fully_connected_layers_zoom_data()

    print('\n\tNASNetMobile zoom data 256\n')
    run_experiment_fit_NASNetMobile_zoom_data()

    print('\n\tNASNetMobile with my classifier zoom data 256\n')
