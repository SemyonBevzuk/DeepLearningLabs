...
нейронных сетей для задачи классификации.

## Данные
Источник данных: [датасет](https://www.kaggle.com/valentynsichkar/traffic-signs-preprocessed)

Необходимо распознать один из 43 дорожных знаков по RGB изображению 32 * 32.

В обучающей выборке содержится 86989 примеров.

В тестирующей выборке содержится 12630 примеров.

Для обучения данные представляются в виде вектор размерностью 32 * 32 * 3 = 3072.
